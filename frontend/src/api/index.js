...
export default {
  ...
  getAnalysisCandidates: (caseId) => api.get(`/llm/cases/${caseId}/analysis-candidates`),
  refreshAnalysisCandidates: (caseId) => api.post(`/llm/cases/${caseId}/analysis-candidates/refresh`),
